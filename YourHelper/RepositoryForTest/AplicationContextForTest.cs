...
namespace RepositoryForTest
{
    public class AplicationContextForTest
    {
        ...
        public AplicationContextForTest()
        {
            ...
            {
                new Schedule { Id = 0, Text = "Test schedule", TimeStart = Convert.ToDateTime("01.01.2021 09:00:00"), TimeEnd = Convert.ToDateTime("01.01.2021 09:30:00"), Date  = Convert.ToDateTime("01.01.2021 09:30:00"), User = Users[0]},
                new Schedule { Id = 1, Text = "Test schedule 2", TimeStart = Convert.ToDateTime("01.01.2021 08:00:00"), TimeEnd = Convert.ToDateTime("01.01.2021 09:40:00"), Date  = Convert.ToDateTime("01.01.2021 09:30:00"), User = Users[1]},
                new Schedule { Id = 2, Text = "Test schedule 3", TimeStart = Convert.ToDateTime("01.01.2021 10:10:00"), TimeEnd = Convert.ToDateTime("01.01.2021 11:30:00"), Date  = Convert.ToDateTime("01.01.2021 09:30:00"), User = Users[2]},
                new Schedule { Id = 3, Text = "Test schedule 4", TimeStart = Convert.ToDateTime("01.01.2021 12:00:00"), TimeEnd = Convert.ToDateTime("01.01.2021 13:30:00"), Date  = Convert.ToDateTime("01.01.2021 09:30:00"), User = Users[0]}
            };
